      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed">
            ...
            <p>Simon Chesire is a member of the <strong className="text-[#1A2E52]">Legal Practice Council (South Africa)</strong> and the <strong className="text-[#1A2E52]">Law Society of Kenya</strong>, with the right of appearance in the High Court. Our firm actively supports the <strong className="text-[#1A2E52]">Don Bosco Centre</strong> charity, providing household items, food and clothing to those in need.</p>
          </div>
