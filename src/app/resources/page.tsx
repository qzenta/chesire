    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm grid grid-cols-1 lg:grid-cols-3">
          <div className="lg:col-span-1 overflow-hidden" style={{ maxHeight: "320px" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/article-featured.jpg" alt="Featured article" className="w-full h-full object-cover object-top" style={{ height: "320px" }} />
          </div>
